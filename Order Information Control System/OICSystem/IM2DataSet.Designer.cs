...
namespace WindowsFormsApplication1 {
    ...
    public partial class IM2DataSet : global::System.Data.DataSet {
        ...
        public partial class 入庫テーブルDataTable : global::System.Data.TypedTableBase<入庫テーブルRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public 入庫テーブルRow Add入庫テーブルRow(System.DateTime 入庫日, 商品マスタRow parent商品マスタRowBy商品マスタ入庫テーブル, short 数量, string 備考, 入庫先マスタRow parent入庫先マスタRowBy入庫先マスタ_のコピー入庫テーブル) {
                ...
                if ((parent入庫先マスタRowBy入庫先マスタ_のコピー入庫テーブル != null)) {
                    columnValuesArray[5] = parent入庫先マスタRowBy入庫先マスタ_のコピー入庫テーブル[0];
                }
...
namespace WindowsFormsApplication1.IM2DataSetTableAdapters {
    ...
    public partial class 税率マスタTableAdapter : global::System.ComponentModel.Component {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(IM2DataSet.税率マスタDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual IM2DataSet.税率マスタDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            IM2DataSet.税率マスタDataTable dataTable = new IM2DataSet.税率マスタDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(IM2DataSet.税率マスタDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
    ...
    public partial class 入庫テーブルTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.OleDb.OleDbCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT            入庫ID, 入庫日, 商品ID, 数量, 入庫先ID, 備考\r\nFROM              入庫テーブル";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.OleDb.OleDbCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT            入庫テーブル.入庫ID, 入庫テーブル.入庫日, 入庫テーブル.商品ID, 入庫テーブル.数量, 入庫先マスタ.入庫先名, 入" +
                "庫テーブル.備考\r\nFROM              (入庫テーブル INNER JOIN\r\n                        入庫先マスタ O" +
                "N 入庫テーブル.入庫先ID = 入庫先マスタ.入庫先ID)";
        ...
        public virtual int FillInMgt(IM2DataSet.入庫テーブルDataTable dataTable) {
        ...
        public virtual IM2DataSet.入庫テーブルDataTable GetInDataBy() {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            IM2DataSet.入庫テーブルDataTable dataTable = new IM2DataSet.入庫テーブルDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
