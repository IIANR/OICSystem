...
namespace WindowsFormsApplication1
{
    public partial class OrderMgtRegister : UserControl
    {
        ...
        private void OrderCompBtn_Click_1(object sender, EventArgs e)
        {
            if (OrderRegiDataGridview.Rows.Count == 0)
            {
                ErrMsg.Visible = true;
        ...
        private void NumCombo_KeyPress_1(object sender, KeyPressEventArgs e)
        {
            e.Handled = true;
        }

        private void PoscodeTextbox_KeyPress_1(object sender, KeyPressEventArgs e)
        {
        ...
        private void TelTextbox_KeyPress_1(object sender, KeyPressEventArgs e)
        {
            if ((e.KeyChar < '0' || '9' < e.KeyChar) && e.KeyChar != '\b')
            {
                //押されたキーが 0～9でない場合は、イベントをキャンセルする
